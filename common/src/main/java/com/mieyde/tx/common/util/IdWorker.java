 ...
 * 分布式id生成器
 *
 * 雪花算法（https://blog.csdn.net/knock_me/article/details/127415351）
 *
 * @author 我吃稀饭面
...
public class IdWorker {
     ...
     * = ~(-1 << workerIdBits)
     */
    private final int maxWorkerId = (1 << workerIdBits) - 1;
     ...
     */
    private final long timestampAndSequenceMask = (1L << (timestampBits + sequenceBits)) - 1;
    ...
    private long generateRandomWorkerId() {
        return RandomUtils.randomInt(0,maxWorkerId + 1);
    }
